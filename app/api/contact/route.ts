...
const schema=z.object({name:z.string().trim().min(2).max(100),email:z.email().max(200),company:z.string().max(150).optional(),projectType:z.string().min(2).max(100),budget:z.string().max(60),timeline:z.string().max(60),message:z.string().min(20).max(5000),website:z.string().max(0).optional()});
