...
export function SkeletonSettingsForm() {
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      {/* 01 / Google Account Card */}
      <div className="skeleton-glass-card p-6 space-y-4 rounded border border-white/[0.08]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Skeleton className="size-8 rounded bg-[#c8ff3d]/20" />
        ...
        <div className="grid md:grid-cols-2 gap-4 pt-2">
          <div className="p-4 rounded bg-white/[0.03] space-y-2 border border-white/[0.04]">
      ...
      {/* 02 / Calendar & Meet Card */}
      <div className="skeleton-glass-card p-6 space-y-4 rounded border border-white/[0.08]">
        <div className="flex items-center gap-3">
          <Skeleton className="size-8 rounded bg-white/10" />
          <div className="space-y-1.5">
...
export function SkeletonGlobeEditor() {
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      {/* 3D Globe Visual Configuration */}
      <div className="grid md:grid-cols-3 gap-5">
        <div className="skeleton-glass-card p-5 space-y-3 rounded">
          <Skeleton className="h-4 w-32 rounded" />
          <Skeleton className="h-10 w-full rounded" />
        </div>
        <div className="skeleton-glass-card p-5 space-y-3 rounded">
      ...
      {/* Client Coordinates & Markers List */}
      <div className="skeleton-glass-card p-6 space-y-4 rounded border border-white/[0.08]">
        <div className="flex items-center justify-between">
          <Skeleton className="h-5 w-44 rounded" />
          <Skeleton className="h-8 w-28 rounded" />
        ...
        <div className="space-y-3 pt-2">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="p-4 rounded bg-white/[0.03] border border-white/[0.04] flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <Skeleton className="size-8 rounded bg-[#c8ff3d]/20" />
...
export function SkeletonSiteEditor() {
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      {/* Header */}
      <div className="flex items-center justify-between pb-4 border-b border-white/[0.08]">
      ...
      {/* Form Cards */}
      <div className="skeleton-glass-card p-6 space-y-5 rounded border border-white/[0.08]">
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto h-[calc(100vh-80px)] flex flex-col space-y-4">
      ...
      <div className="grid grid-cols-12 gap-5 flex-1 min-h-0">
        {/* Left List */}
        <div className="col-span-4 skeleton-glass-card p-4 space-y-3 rounded overflow-hidden flex flex-col">
          <Skeleton className="h-9 w-full rounded mb-1" />
          <div className="space-y-2 flex-1">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="p-3 rounded bg-white/[0.03] space-y-1.5 border border-white/[0.04]">
        ...
        {/* Right Chat Thread */}
        <div className="col-span-8 skeleton-glass-card p-6 rounded flex flex-col justify-between">
          <div className="flex items-center justify-between pb-4 border-b border-white/[0.08]">
            <div className="flex items-center gap-3">
              <Skeleton className="size-8 rounded bg-[#c8ff3d]/20" />
              <div className="space-y-1">
          ...
          <div className="space-y-4 my-6 flex-1">
            <div className="flex gap-3 max-w-md">
              <Skeleton className="size-6 rounded bg-[#c8ff3d]/20 shrink-0" />
              <Skeleton className="h-12 w-full rounded bg-white/[0.04]" />
            </div>
            <div className="flex gap-3 max-w-md ml-auto justify-end">
              <Skeleton className="h-9 w-64 rounded bg-[#c8ff3d]/30" />
            </div>
            <div className="flex gap-3 max-w-md">
              <Skeleton className="size-6 rounded bg-[#c8ff3d]/20 shrink-0" />
              <Skeleton className="h-16 w-full rounded bg-white/[0.04]" />
            </div>
          </div>
